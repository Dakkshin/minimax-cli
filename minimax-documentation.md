...
1. Click the "**Frontier Model**" button to enter Cline's model selection interface
2. OTHER OPTIONS -> Search and select "**MiniMax-M2.1**"

<img src="https://file.cdn.minimax.io/public/1cd4358c-7a62-408d-816d-73a36a2eca41.png" width="60%" />

3. Click "Done" in the top-right corner to save the configuration

4. Enable the "Edit" checkbox in Auto-approve section, then start using "MiniMax-M2.1"

<img src="https://file.cdn.minimax.io/public/fc0ce219-9705-426b-a199-5fbf18577e2f.png" width="80%" />
