...
import { CommandSuggestions, FileSuggestions } from "./command-suggestions.js";
      ...
      {!confirmationOptions && (
        <>
          ...
          <FileSuggestions
            ...
            input={input.includes("@") ? input.substring(input.indexOf("@") + 1) : ""}
            selectedIndex={selectedFileIndex}
            isVisible={showFileSuggestions && input.includes("@")}
          />
...
export default function ChatInterface({
  ...
  const [currentAgent, setCurrentAgent] = useState<MiniMaxAgent | null>(
    agent || null
  );

  const handleApiKeySet = (newAgent: MiniMaxAgent) => {
